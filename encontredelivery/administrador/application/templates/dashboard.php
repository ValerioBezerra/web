...
<head>
	...
	<title>Encontre Delivery | Painel Administrativo</title>
	...
	<div id="wrapper">
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo site_url('')?>">Encontre Delivery | {DLV_NOME_EMP}</a>
			</div>
					...
					<ul class="nav" id="side-menu">                        
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a  style="{DISPLAY_VALLESOFT}" href="<?php echo site_url('segmento')?>">Segmentos</a>
								</li>
								<li>
									<a style="{DISPLAY_VALLESOFT}" href="<?php echo site_url('cargo')?>">Cargos</a>
								</li>
								<li>
									<a style="{DISPLAY_VALLESOFT}" href="<?php echo site_url('responsavel')?>">Responsáveis</a>
								</li>                                
								<li>
									<a style="{DISPLAY_VALLESOFT}" href="<?php echo site_url('forma_pagamento')?>">Formas de Pagamento</a>
								</li>
								<li>
									<a style="{DISPLAY_VALLESOFT}" href="<?php echo site_url('rede_social')?>">Redes Sociais</a>
								</li>
								<li>
									<a  style="{DISPLAY_VALLESOFT}" href="<?php echo site_url('status')?>">Status</a>
								</li>
								<li>
...
<!-- 								<li> 
	...
	<script>
	    $(document).ready(function() {
	        ...
	        $('#tb_status').dataTable({"order": [[ 1, "asc" ]]});
