...
class Endereco_Model extends CI_Model {
	...
	public function getEnderecoCompletoCliente($dlv_dlvcli_ecl) {
		$this->db->from('dlv_ecl');
		$this->db->join('glo_end', 'glo_id_end = dlv_gloend_ecl');
		$this->db->join('glo_bai', 'glo_id_bai = glo_globai_end');
		$this->db->join('glo_cid', 'glo_id_cid = glo_glocid_bai');
		$this->db->join('glo_est', 'glo_id_est = glo_gloest_cid');
...
// 		} 
	...
	public function insertEnderecoCliente($endereco_cliente) {
		$res = $this->db->insert('dlv_ecl', $endereco_cliente);
	...
	public function deleteEnderecoCliente($dlv_id_ecl) {
		$this->db->where('dlv_id_ecl', $dlv_id_ecl, FALSE);
		return $this->db->delete('dlv_ecl');
	}
