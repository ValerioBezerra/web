						...
						<div class="panel-body">
								<div class="form-group">		
									<div class="col-sm-offset-1 col-sm-10">	
										<select class="form-control" id="bus_tipopessoa_emp" name="bus_tipopessoa_emp" onchange="alterarCpfCnpj(this)" autofocus>
								...
								<div class="form-group">							
									<div id="div_bus_cpfcnpj_emp_f" class="{CLASS_DIV_BUS_CPFCNPJ_EMP_F} {ERRO_BUS_CPFCNPJ_EMP}">
										<div class="col-sm-offset-1 col-sm-10">
											<input type="text" class="form-control" id="bus_cpfcnpj_emp_f" data-mask="{MASCARA_CPF}" placeholder="CPF"
												   name="bus_cpfcnpj_emp" value="{bus_cpfcnpj_emp}" {DIV_BUS_CPFCNPJ_EMP_F}/>
										</div>
									</div>		
												
									<div id="div_bus_cpfcnpj_emp_j" class="{CLASS_DIV_BUS_CPFCNPJ_EMP_J} {ERRO_BUS_CPFCNPJ_EMP}">
										<div class="col-sm-offset-1 col-sm-10">
											<input type="text" class="form-control" id="bus_cpfcnpj_emp_j" data-mask="{MASCARA_CNPJ}" placeholder="CNPJ"
												   name="bus_cpfcnpj_emp" value="{bus_cpfcnpj_emp}" {DIV_BUS_CPFCNPJ_EMP_J}/>
										</div>
									</div>	
								</div>	
								...
								<div class="form-group {ERRO_BUS_LOGIN_USU}">							
									<div class="col-sm-offset-1 col-sm-10">
										<input type="text" class="form-control" id="bus_login_usu" placeholder="Login"
											   name="bus_login_usu" value="{bus_login_usu}" maxlength="15"/>
									</div>
								</div>
								
								<div class="form-group {ERRO_BUS_SENHA_USU}">
									<div class="col-sm-offset-1 col-sm-10">
										<input class="form-control" placeholder="Senha" name="bus_senha_usu" type="password" value="" maxlength="8">
									</div>	
								</div>
